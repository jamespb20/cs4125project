...
class SGDStrategy(classifierStrategy):
    def __init__(self):
        self.classifier = SGDClassifier(loss='log_loss', tol=1e-3, random_state=0, learning_rate="adaptive", eta0 = 0.01, max_iter=100)
...
class AdaBoostingStrategy(classifierStrategy):
    def __init__(self):
        self.classifier = AdaBoostClassifier(n_estimators=50, random_state=0, learning_rate=0.5)
...
class MLPStrategy(classifierStrategy):
    def __init__(self):
        self.classifier = MLPClassifier(hidden_layer_sizes=(100,), random_state=0, learning_rate="adaptive", max_iter=100)
